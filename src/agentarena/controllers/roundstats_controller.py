"""
RoundStats controller for the Agent Arena application.
...
router = APIRouter(tags=["RoundStats"])
...
async def create_roundstats(
    ...
    roundstats_service: ModelService[RoundStats] = Depends(Provide[Container.roundstats_service])
) -> Dict[str, str]:
    """
